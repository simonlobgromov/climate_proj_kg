...
Мы получили эти данные в высоком разрешении в виде множества цисловых массивов, которые объединили, получив карту высот для территории Кыргызстана. 
...
Так были полученны дополнительные данные по рельефу. Вот пример иллюстрации, полученной на основании карты градиента рельефа:
